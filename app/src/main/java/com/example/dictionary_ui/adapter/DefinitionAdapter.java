...
import com.example.dictionary_ui.models.Definition;

import java.util.ArrayList;
import java.util.List;

public class DefinitionAdapter extends RecyclerView.Adapter<DefinitionAdapter.MeaningViewHolder> {
    ...
    public static class MeaningViewHolder extends RecyclerView.ViewHolder {
        ...
        public MeaningViewHolder(@NonNull View itemView) {
            super(itemView);
            tvMeaning = itemView.findViewById(R.id.tvDefinition);
